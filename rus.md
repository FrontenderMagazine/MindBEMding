...
Другим плюсом является ясность взаимосвязей внутри разметки. Рассмотрим пример с
...
неизменённый элемент блока `.media`. Вся картина взаимосвязей успешно
...
БЭМ может выглядеть смешным — и он вынудит вас больше печатать (большинство
